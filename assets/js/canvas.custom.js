//This Javascript is based on  yangfan's work.
var canvas,ctx;
	var vertexes = [];
	...
	function resize(){
		canvasW = document.getElementById('container').offsetWidth + 40;	initCanvas(canvasW,window.innerHeight);
			...
			for(var i = 0;i < verNum;i++)
				vertexes[i] = new Vertex(cW / (verNum -1) * i , cH*75/100, cH*70/100);
			initDiffPt();
	...
	function init(){
		...
		//顏色事件	
		// document.getElementById("picker1").addEventListener('change', function (e) {
		// 	color1 = e.target.value;
		// });
		// document.getElementById("picker2").addEventListener('change', function (e) {
